...
function Logout() {
  ...
  <h1 className="text-3xl text-black font-medium mx-auto text-center">Get’s started.</h1>
  <p className="text-slate-500 text-center">Don’t have an account? <span className="text-[#7437ca]">Sign up</span></p>
  <div className="my-5">
